...
interface BilanSortieData {
  dateBilan: string;
  syntheseParcours: string;
  rdvFT: string;
  pointsVigilance: string;
  commentairesBeneficiaire: string;
  termeDuDispositif: boolean;
  suiviNecessaire: string;
  dateProposee: string;
  sortieAnticipeePositive: boolean;
  dateSortie: string;
  motifSortie: string;
  abandon: boolean;
  dateAbandon: string;
...
const BilanSortieForm = () => {
  const [bilanSortieData, setBilanSortieData] = useState<BilanSortieData>({
    dateBilan: '',
    syntheseParcours: '',
    rdvFT: '',
    pointsVigilance: '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("Bilan de sortie enregistré");
  };
...
export default BilanSortieForm;
